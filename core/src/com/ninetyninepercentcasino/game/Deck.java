 ...
 */
class Deck {
	private ArrayList<Card> cardsInDeck = new ArrayList<Card>(); //stores the cards in the deck in the form of Card objects
	...
	public Deck() {
		for(int i = 1; i <= 13; i++){
			cardsInDeck.add(new Card(i, 0));
			cardsInDeck.add(new Card(i, 1));
			cardsInDeck.add(new Card(i, 2));
			cardsInDeck.add(new Card(i, 3));
		}
	}
	/**
	 ...
	 */
	public void shuffle() {
		ArrayList<Card> shuffledDeck = new ArrayList<Card>(); //this will store the shuffled deck
